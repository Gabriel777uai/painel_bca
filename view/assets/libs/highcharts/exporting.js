   ...
   */ (function (e, t) {
    ...
    (() => {
      ...
      f.compose = function (e) {
        return (e.navigation || (e.navigation = new m(e)), e);
      };
      class m {
        constructor(e) {
      ...
      function S(e, t) {
          ...
          !(e =
            (function (e) {
              ...
              if (
                ...
                return b.createObjectURL(new w.Blob([i], { type: t[1] }));
              }
            })(e) || "")
        )
        ...
        if (void 0 !== i.download)
          ((i.href = e),
            (i.download = t),
            v.body.appendChild(i),
            i.click(),
            v.body.removeChild(i));
        else
          try {
            if (!w.open(e, "chart")) throw Error("Failed to open window");
          } catch {
            w.location.href = e;
          }
      }
        ...
        (a &&
          a.call(
            ...
            !!h().supportsPassiveEvents && {
              passive:
                void 0 === i.passive ? -1 !== t.indexOf("touch") : i.passive,
              capture: !1,
            },
          ),
          r[t] || (r[t] = []));
        let l = { fn: n, order: "number" == typeof i.order ? i.order : 1 / 0 };
        return (
          r[t].push(l),
          r[t].sort((e, t) => e.order - t.order),
          function () {
            V(e, t, n);
          }
        );
      ...
      function P(e, t, n, i, o) {
        ...
        return (
          t && A(r, t),
          o && R(r, { padding: "0", border: "none", margin: "0" }),
          n && R(r, n),
          i && i.appendChild(r),
          r
        );
      ...
      function L(e, t, n, i) {
        if (
          ((n = n || {}),
          T?.createEvent && (e.dispatchEvent || (e.fireEvent && e !== h())))
        ) {
          let i = T.createEvent("Events");
          (i.initEvent(t, !0, !0),
            (n = A(i, n)),
            e.dispatchEvent ? e.dispatchEvent(n) : e.fireEvent(t, n));
        } else if (e.hcEvents) {
          n.target ||
            A(n, {
          ...
          for (; o.hcEvents; )
            (Object.hasOwnProperty.call(o, "hcEvents") &&
              o.hcEvents[t] &&
              (i.length && (r = !0), i.unshift.apply(i, o.hcEvents[t])),
              (o = Object.getPrototypeOf(o)));
          (r && i.sort((e, t) => e.order - t.order),
            i.forEach((t) => {
              !1 === t.fn.call(e, n, e) && n.preventDefault();
            }));
        }
        i && !n.defaultPrevented && i.call(e, n);
      }
      let D = Array.prototype.find
        ...
        : function (e, t) {
            let n,
              i = e.length;
            for (n = 0; n < i; n++) if (t(e[n], n)) return e[n];
          };
      function H(e) {
      ...
      function I(e, t) {
        return !!e && "object" == typeof e && (!t || !j(e));
      }
      function U(e, ...t) {
        let n,
          i = [e, ...t],
            ...
            return (
              ...
              B(t, function (n, i) {
                if ("__proto__" !== i && "constructor" !== i) {
                  ...
                  !I(n, !0) ||
                  ((o = n?.constructor),
                  I(n, !0) && !M(n) && o?.name && "Object" !== o.name) ||
                  M(n)
                    ? (e[i] = t[i])
                    : (e[i] = r(e[i] || {}, n));
                }
        ...
        !0 === e && ((o = i[1]), (i = Array.prototype.slice.call(i, 2)));
        let a = i.length;
        for (n = 0; n < a; n++) o = r(o, i[n]);
        return o;
      }
      function B(e, t, n) {
        for (let i in e)
          Object.hasOwnProperty.call(e, i) && t.call(n || e[i], e[i], i, e);
      }
      function $() {
        let e = arguments,
          t = e.length;
      ...
      function V(e, t, n) {
        ...
        function o(n) {
          ...
          e.nodeName &&
            (t ? ((o = {})[t] = !0) : (o = n),
            B(o, function (e, t) {
              if (n[t]) for (r = n[t].length; r--; ) i(t, n[t][r].fn);
            }));
        }
          ...
          if (t) {
            ...
            n
              ? ((e[t] = r.filter(function (e) {
                ...
                i(t, n))
              : (o(e), (e[t] = []));
          } else (o(e), delete r.hcEvents);
        }
      }
      let { composed: W } = h();
      function q() {
        this.fullscreen = new z(this);
      }
      class z {
        static compose(e) {
          G(W, "Fullscreen") && F(e, "beforeRender", q);
        }
        constructor(e) {
        ...
        close() {
          let e = this,
            t = e.chart,
            n = t.options.chart;
          L(t, "fullscreenClose", void 0, function () {
            (e.isOpen &&
              e.browserProps &&
        ...
        open() {
          let e = this,
            t = e.chart,
            n = t.options.chart;
          L(t, "fullscreenOpen", void 0, function () {
            if (
              (n &&
          ...
          if (
            ...
            e &&
              d().setElementHTML(
                ...
                this.isOpen
                  ? o.exitFullscreen
                  : n.menuItemDefinitions.viewFullscreen?.textKey ||
                      o.viewFullscreen,
              );
          }
        }
      ...
      _.post = async function (e, t, n) {
        let i = new K.FormData();
        (B(t, function (e, t) {
          i.append(t, e);
        }),
          i.append("b64", "true"));
        let o = await K.fetch(e, { method: "POST", body: i, ...n });
        if (o.ok) {
          let e = await o.text(),
      ...
      let { defaultOptions: J, setOptions: X } = h(),
        {
          composed: Y,
          doc: Z,
          isFirefox: Q,
      ...
      class er {
        ...
        static async fetchCSS(e) {
          try {
            let t = await fetch(e),
              n = await t.text(),
              i = new CSSStyleSheet();
            return (i.replaceSync(n), i);
          } catch {
            (0, c.error)(`Warning: Failed to fetch CSS from ${e}`, !1);
          }
        }
          ...
          try {
            for (let n of Array.from(e.cssRules)) {
              if (n instanceof CSSImportRule) {
                ...
                e && (await er.handleStyleSheet(e, t));
              }
            ...
            if (e.href) {
              ...
              n && (await er.handleStyleSheet(n, t));
            }
          }
        }
        static async fetchStyleSheets() {
          let e = [];
          for (let t of Array.from(Z.styleSheets))
            await er.handleStyleSheet(t, e);
          return e;
        }
        static async inlineFonts(e) {
          ...
          return ((s.textContent = o), e.append(s), e);
        }
        static loadImage(e) {
        ...
        addButton(e) {
          let t,
            ...
            i = n.chart,
            o = i.renderer,
            r = U(i.options.navigation?.buttonOptions, e),
            a = r.onclick,
            l = r.menuItems,
            s = r.symbolSize || 12;
          ...
          (a
            ? (h = function (e) {
                (e && e.stopPropagation(), a.call(i, e, i));
              })
            : l &&
              (h = function (e) {
                (e && e.stopPropagation(),
            ...
            r.text && r.symbol
              ? (c.paddingLeft = $(c.paddingLeft, 30))
              : r.text ||
                A(c, { width: r.width, height: r.height, padding: 0 }));
          let p = o
            .button(
              r.text || "",
              0,
            ...
            .attr({ title: $(i.options.lang[r._titleKey || r.titleKey], "") });
          ((p.menuClassName =
            ...
            r.symbol &&
              ((t = o
                .symbol(
                  r.symbol,
                  Math.round((r.symbolX || 0) - s / 2),
                  Math.round((r.symbolY || 0) - s / 2),
                  s,
                  s,
                  { width: s, height: s },
                )
            ...
            p
              .add(n.group)
              .align(
                A(r, { width: p.width, x: $(r.x, n.buttonOffset) }),
                !0,
                "spacingBox",
              ),
            (n.buttonOffset +=
        ...
        contextMenu(e, t, n, i, o, r, a) {
          ...
          m ||
            ((l.contextMenuEl =
              ...
              m =
                P(
                  ...
                  s.scrollablePlotArea?.fixedDiv || s.container,
                )),
            (f = P(
              "ul",
              { className: "highcharts-menu" },
              s.styledMode ? {} : { listStyle: "none", margin: 0, padding: 0 },
              m,
            )),
            s.styledMode ||
              R(
            ...
            (m.hideMenu = function () {
              (R(m, { display: "none" }),
                a && a.setState(0),
                s.exporting && (s.exporting.openMenu = !1),
                R(s.renderTo, { overflow: "hidden" }),
                R(s.container, { overflow: "hidden" }),
                H(m.hideTimer),
                L(s, "exportMenuHidden"));
            }),
            l.events?.push(
              F(m, "mouseleave", function () {
                m.hideTimer = ei.setTimeout(m.hideMenu, 500);
              }),
              F(m, "mouseenter", function () {
                H(m.hideTimer);
              }),
              F(Z, "mouseup", function (t) {
                s.pointer?.inClass(t.target, e) || m.hideMenu();
              }),
              F(m, "click", function () {
                s.exporting?.openMenu && m.hideMenu();
              }),
            ),
                      ...
                      "li",
                      {
                        ...
                        onclick: function (t) {
                          (t && t.stopPropagation(),
                            ...
                            "string" != typeof e &&
                              e.onclick &&
                              e.onclick.apply(s, arguments));
                        },
                      },
                      void 0,
                      f,
                    )),
                    d().setElementHTML(t, e.text || s.options.lang[e.textKey]),
                    s.styledMode ||
                      ((t.onmouseover = function () {
                        R(this, c?.menuItemHoverStyle || {});
                      }),
                      (t.onmouseout = function () {
                        R(this, c?.menuItemStyle || {});
                      }),
                      R(t, A({ cursor: "pointer" }, c?.menuItemStyle || {})))),
          ...
          (n + (l.menuWidth || 0) > h
            ? (y.right = h - n - o - g + "px")
            : (y.left = n - g + "px"),
            i + r + (l.menuHeight || 0) > p &&
            a.alignOptions?.verticalAlign !== "top"
              ? (y.bottom = p - i - g + "px")
              : (y.top = i + r - g + "px"),
            R(m, y),
            R(s.renderTo, { overflow: "" }),
            R(s.container, { overflow: "" }),
            s.exporting && (s.exporting.openMenu = !0),
            L(s, "exportMenuShown"));
        }
        destroy(e) {
          let t,
        ...
        async downloadSVG(e, t) {
          ...
          if ((L(er.prototype, "downloadSVG", i), i.defaultPrevented)) return;
          let {
            type: o,
            filename: r,
            scale: a,
          ...
          if ("image/svg+xml" === o) {
            ...
            try {
              ...
              if ("No canvas found!" === p.message) throw p;
              if (e.length > 1e8) throw Error("Input too long");
              let t = Z.createElement("canvas"),
                n = t.getContext("2d"),
                i = e.match(
              ...
              if (n && i && h) {
                let p = i[1] * a,
                  d = h[1] * a;
                if (((t.width = p), (t.height = d), !ei.canvg)) {
                  var s;
                  ((er.objectURLRevoke = !0),
                    await ((s = l + "canvg.js"),
                    new Promise((e, t) => {
                      let n = v.getElementsByTagName("head")[0],
                      ...
                      ((i.type = "text/javascript"),
                        ...
                        (i.onerror = () => {
                          let e = `Error loading script ${s}`;
                          ((0, c.error)(e), t(Error(e)));
                        }),
                        n.appendChild(i));
                    })));
                }
                (ei.canvg.Canvg.fromString(n, e).start(),
                  S(
                    ei.navigator.msSaveOrOpenBlob
                      ? t.msToBlob()
                      : t.toDataURL(o),
                    r,
                  ));
        ...
        async exportChart(e, t) {
          if ((e = U(this.options, e)).local)
            await this.localExport(e, t || {});
          else {
            let n = await this.getSVGForExport(e, t);
            e.url &&
              (await _.post(
                e.url,
                {
        ...
        getChartHTML(e) {
          ...
          return (
            ...
            t.container.querySelectorAll("canvas").forEach(function (e) {
              let n = e.toDataURL("image/png"),
                i = e.parentNode,
                o = t.renderer.image(n, 0, 0, e.width, e.height);
              (R(o.element, { width: e.style.width, height: e.style.height }),
                i.parentNode.insertBefore(o.element, i),
                i.remove());
            }),
        ...
        getSVG(e, t) {
          let n = this.chart,
            ...
            o,
            r = U(n.options, e);
          ((r.plotOptions = U(n.userOptions.plotOptions, e?.plotOptions)),
            (r.time = U(n.userOptions.time, e?.time)));
          let a = P(
              "div",
              void 0,
              {
            ...
            l = n.renderTo.style.width,
            s = n.renderTo.style.height,
            h =
              r.exporting?.sourceWidth ||
              r.chart.width ||
              (/px$/.test(l) && parseInt(l, 10)) ||
              (r.isGantt ? 800 : 600),
            p =
              r.exporting?.sourceHeight ||
              r.chart.height ||
          ...
          (A(r.chart, {
            ...
            r.exporting && (r.exporting.enabled = !1),
            delete r.data,
            (r.series = []),
            n.series.forEach(function (e) {
              (o = U(e.userOptions, {
                ...
                showCheckbox: !1,
                visible: e.visible,
              })).isInternal || r?.series?.push(o);
            }));
          let d = {};
          (n.axes.forEach(function (e) {
            (e.userOptions.internalKey ||
              (e.userOptions.internalKey = (0, c.uniqueKey)()),
              r &&
                !e.options.isInternal &&
                (d[e.coll] || ((d[e.coll] = !0), (r[e.coll] = [])),
                r[e.coll].push(
                  U(e.userOptions, {
                    visible: e.visible,
                    type: e.type,
            ...
            (r.colorAxis = n.userOptions.colorAxis));
          let u = (t) => {
            (e &&
              ["xAxis", "yAxis", "series"].forEach(function (n) {
                e[n] && t.update({ [n]: e[n] });
              }),
              n.axes.forEach(function (n) {
                let i = D(
                  t.axes,
                  (e) => e.options.internalKey === n.userOptions.internalKey,
                );
                if (i) {
                  var o;
                  let t = n.getExtremes(),
                    r = (j((o = e?.[n.coll] || {})) ? o : [o])[0],
                    a = "min" in r ? r.min : t.userMin,
                    l = "max" in r ? r.max : t.userMax;
                  ((void 0 !== a && a !== i.min) ||
                    (void 0 !== l && l !== i.max)) &&
                    i.setExtremes(a ?? void 0, l ?? void 0, !0, !1);
                }
              }));
            let o = t.exporting;
            return (
              o?.options.applyStyleSheets && this.applyShadowDOMStyles(t),
              (i =
                o?.getChartHTML(
                  n.styledMode || r?.exporting?.applyStyleSheets,
                ) || ""),
              L(n, "getSVG", { chartCopy: t }),
              (i = er.sanitizeSVG(i, r)),
              (r = void 0),
              t.destroy(),
              N(a),
              i
          ...
          return t
            ? new Promise(
                (e) =>
                  new n.constructor(r || {}, function (t) {
                    (n.callback?.call(this, t), e(u(this)));
                  }),
              )
            : u(new n.constructor(r, n.callback));
        }
        applyShadowDOMStyles(e) {
          let t = this.chart,
            ...
            i = t.container,
            o;
          for (; i && (!(o = i.getRootNode()) || "object" != typeof o.host); )
            ((i = i.parentNode), (o = null));
          (o?.querySelectorAll("style").forEach((t) => {
            let i = t.cloneNode(!0);
            (e.container.appendChild(i), n.push(i));
          }),
            F(t, "getSVG", () => {
              n.forEach((e) => {
                e.remove();
        ...
        async getSVGForExport(e, t) {
          let n = this.options;
          return await this.getSVG(
            U({ chart: { borderRadius: 0 } }, n.chartOptions, t, {
              exporting: {
        ...
        inlineStyles() {
          ...
          (r && r.body.appendChild(r.createElementNS(en, "svg")),
            !(function o(a) {
              let l,
                s,
                c,
              ...
              if (
                ...
                if (
                  ((l = ei.getComputedStyle(a, null)),
                  (s =
                    "svg" === a.nodeName
                      ? {}
                      : ei.getComputedStyle(a.parentNode, null)),
                  !i[a.nodeName])
                ) {
                  ((e = r.getElementsByTagName("svg")[0]),
                    (c = r.createElementNS(a.namespaceURI, a.nodeName)),
                    e.appendChild(c));
                  let t = ei.getComputedStyle(c, null),
                    n = {};
                  for (let e in t)
                    e.length < 1e3 &&
                      "string" == typeof t[e] &&
                ...
                for (let e in l)
                  (Q || ee || et || Object.hasOwnProperty.call(l, e)) &&
                    (function (e, o) {
                      if (((h = p = !1), n.length)) {
        ...
        async localExport(e, t) {
          ...
          try {
            let n;
            for (let n of (await this.getSVGForExport(e, t),
            a ? Array.from(a) : []))
              if (
            ...
            let l = i?.querySelector("svg");
            l &&
              !e.chartOptions?.chart?.style?.fontFamily &&
              (await er.inlineFonts(l));
            let s = ((n = i?.innerHTML), er.sanitizeSVG(n || "", o));
            if (
              s.indexOf("<foreignObject") > -1 &&
              "image/svg+xml" !== e.type &&
              (ee || "application/pdf" === e.type)
            )
              throw Error(
                "Image type not supported for charts with embedded HTML",
              );
            return (
              await this.downloadSVG(s, A({ filename: this.getFilename() }, e)),
              s
            );
          } catch (t) {
        ...
        (function (e) {
          ...
          function i({ alignTo: e, key: t, textPxLength: n }) {
            ...
            (i?.enabled ?? !0) &&
              ...
              (s < c
                ? (e.width -= c)
                : this.title?.alignValue !== "left" && (e.x -= c - s / 2));
          }
            ...
            (O.compose(r),
              ...
              G(Y, "Exporting") &&
                (A(g().prototype, {
                  ...
                  getSVG: function (e) {
                    return this.exporting?.getSVG(e, !1);
                  },
                  print: function () {
                ...
                F(o, "layOutTitle", i),
                et &&
                  ei.matchMedia("print").addListener(function (t) {
                    e.printingChart &&
                      (t.matches
      ...
      let ea = h();
      ((ea.Exporting = er),
        (ea.HttpUtilities = ea.HttpUtilities || _),
        (ea.ajax = ea.HttpUtilities.ajax),
        (ea.getJSON = ea.HttpUtilities.getJSON),
        (ea.post = ea.HttpUtilities.post),
        er.compose(ea.Chart, ea.Renderer));
      let el = h();
      return s.default;
    })(),
  )
